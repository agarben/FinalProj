...
//				if (network_coding_on) {								// TODO: Should happen if im the target/relay
//					source_list = GetSourceFromString(buf);
//					if (CountSources(source_list) > 1) {                 a1+a2
//						Decode(buf,source_list.....);                   1)     a1V
//						                                     			2)     a2X
//						Send();
//					} else {
//						Send();
